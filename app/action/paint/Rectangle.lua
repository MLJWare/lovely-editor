...
function Action:undo(data)
  ...
  for i, x, y in paint_iter.rectangle(self._x1, self._y1, self._x2, self._y2, data:getDimensions()) do
...
function Action:redo(data)
  ...
  for _, x, y in paint_iter.rectangle(self._x1, self._y1, self._x2, self._y2, data:getDimensions()) do
...
function Action.apply(data, x1, y1, x2, y2, hex_color)
  ...
  for i, x, y in paint_iter.rectangle(x1, y1, x2, y2, data:getDimensions()) do
